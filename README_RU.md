# TB335FC-flash-guide
Инструкция по прошивке планшета Lenovo Xiaoxin Pad 11 2025 (China) прошивкой Lenovo Tab K11 Gen 2 (Global).
...
- Доработанный файл scatter: [MT6835_Android_scatter.xml](https://github.com/user-attachments/files/28256549/MT6835_Android_scatter.xml)
...
- ☑️ **Не снимайте галочки** ни с каких пунктов в инструменте прошивки, если до конца не понимаете последствия
