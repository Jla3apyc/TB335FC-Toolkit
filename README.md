...
- Custom scatter file: [MT6835_Android_scatter.xml](https://github.com/user-attachments/files/28114209/MT6835_Android_scatter.xml)
- USB cable and a **powered-off** tablet

## 🔧 Step-by-Step Guide
1. Extract both firmware packages into **separate folders** on your PC.
2. Copy the `dtbo.img` file from `TB335FC_ZUXOS_1.5.10.172/image/` to `TB336FU_ZUI_17.5.10.213/image/` (**overwrite** the existing file)
3. Place the custom scatter file `MT6835_Android_scatter.xml` into `TB336FU_ZUI_17.5.10.213/image/`
4. Launch the flashing tool `SPFlashToolV6.exe` from the `TB336FU_ZUI_17.5.10.213`
5. Configure **SP Flash Tool**:
